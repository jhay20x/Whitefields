...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_username']) && isset($_SESSION['account_type'])) {
    if ($_SESSION['account_type'] == 1) {
        ...
        if (is_int($id)) {
            $stmt = $conn->prepare("SELECT * FROM `secretary_info` WHERE `id` = ?;");
                            ...
                            <form autocomplete="off" action="php/insert-update-info.php" method="POST" class="text-center" id="myForm">
                                <div class="mt-4">
                                    <div class="input-group my-3">
                                        ...
                                        <input type="text" name="fname" placeholder="First Name"  id="fname" value="<?php echo $fname ? $fname : ''; ?>" class="form-control">
                                    </div>
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <input type="text" name="age" placeholder="Age"  id="age" value="<?php echo $age ? $age : ''; ?>" class="form-control">
                                    </div>
                                    ...
                                    <div class="input-group d-flex align-items-center my-3">
                                        ...
                                        <input type="text" name="occupation" placeholder="Occupation" id="occupation" value="<?php echo $occupation ? $occupation : ''; ?>" class="form-control">
                                        <span class="ms-2">
                                            <input class="input-group-addon" id="nooccupation" name="nooccupation" type="checkbox"<?php echo $occupation == "None" ? ' checked="checked"' : ''; ?>>
                                            <label for="nooccupation">No Occupation</label>
                                        </span>
