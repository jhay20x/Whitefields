                                                ...
                                                <div class="row mb-3">
                                                    <div class="ms-3">
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $sun_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-7 col-md-5 col-lg-4 col-xl-2">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $mon_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-7 col-md-5 col-lg-4 col-xl-2">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $tue_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-7 col-md-5 col-lg-4 col-xl-2">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $wed_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-7 col-md-5 col-lg-4 col-xl-2">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $thu_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-7 col-md-5 col-lg-4 col-xl-2">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $fri_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn btn-sm btn-outline-secondary availabilityBtn" value="<?php echo $sat_id ?>" data-bs-toggle="modal" data-bs-target="#availabilityModal"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#pencil-square"/></svg></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
