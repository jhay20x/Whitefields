                    ...
                    <table id="myTable" class="table-group-divider table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            $stmt = $conn->prepare("SELECT CONCAT(pi.fname , CASE WHEN pi.mname = 'None' THEN ' ' ELSE CONCAT(' ' , pi.mname , ' ') END , pi.lname) AS Name, 
                                pi.id AS ID, pi.contactno AS Contact, pi.bdate AS Bdate
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="appointID">
                                        <button type="button" value="' . $row['ID'] . '" class="btn btn-sm btn-primary viewAptDetail" data-bs-toggle="modal" data-bs-target="#patientViewModal">View
                                        </button>
                                        </td>
                                    </tr>
                                ';
