        ...
        function fetchPatientDetails(pid, id) {
            ...
            $.ajax({
                ...
                let details = {
                    ...
                    "#uses_alcohol_drugs": data.uses_alcohol_drugs, "#is_allergic_anesthetic": data.is_allergic_anesthetic, "#is_allergic_penicillin": data.is_allergic_penicillin,
                    ...
                    "#bleeding_time": data.bleeding_time, "#is_pregnant": data.is_pregnant, "#is_nursing": data.is_nursing, "#is_birth_control": data.is_birth_control,
                    "#blood_type": data.blood_type, "#blood_pressure": data.blood_pressure
                };
                ...
                $.each(detailsText, function(selector, value) {
                    ...
                    let text = (value === "Yes" && extraValue) ? value + ", " + extraValue : value;
