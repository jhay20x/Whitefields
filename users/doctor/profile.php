...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_username']) && isset($_SESSION['account_type'])) {
    if ($_SESSION['account_type'] == 3) {
        ...
        if (is_int($id)) {
            $stmt = $conn->prepare("SELECT di.lname, di.fname, di.mname, di.specialist, di.bdate, di.contactno, di.gender, di.address, di.about_me, di.religion, di.nationality, ac.username, ac.email_address
                    ...
                    <div class="container-fluid">                                                
                        <form autocomplete="off" action="php/insert-update-info.php" method="POST" class="text-center col" id="myForm">
                            ...
                            <div class="row">                                    
                                <div class="col-0 col-lg-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="specialist" placeholder="Age"  id="specialist" value="<?php echo $specialist ?? ''; ?>" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">                                        
                                ...
                                <div class="col-0 col-lg-3">
                                    <div class="input-group mb-3">
                                        <label class="input-group-text" for="contnumber">Contact No.</label>
                            ...
                            <div class="row">
                                <div class="col-0 col-lg">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="aboutme" placeholder="Occupation" id="aboutme" value="<?php echo $aboutme ?? ''; ?>" class="form-control">
                                    </div>                                            
                                </div>
                            </div>
