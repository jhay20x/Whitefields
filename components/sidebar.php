...
<div id="sidebar">
  <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 350px; height: 100vh; background-color: rgba(166,143,98,255);">
    ...
    <!-- <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="#" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'dashboard.php') ? 'active' : 'text-white'; ?>" aria-current="page">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#columns-gap"/></svg>
            Dashboard
            </a>
        </li>
        <li>
            <a href="#" data-bs-toggle="dropdown" aria-expanded="false" class="nav-link dropdown-toggle <?php echo (basename($_SERVER['PHP_SELF']) == 'appointment.php') ? 'active' : 'text-white'; ?>">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#calendar3"/></svg>
            Appointment
            </a>
        ...
        <li>
            <a href="#" class="nav-link  <?php echo (basename($_SERVER['PHP_SELF']) == 'patient.php') ? 'active' : 'text-white'; ?>">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#person"/></svg>
            Patient
            </a>
        </li>
        <li>
            <a href="#" class="nav-link  <?php echo (basename($_SERVER['PHP_SELF']) == 'dentist.php') ? 'active' : 'text-white'; ?>">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#person-vcard"/></svg>
            Dentist
            </a>
        </li>
        <li>
            <a href="#" class="nav-link  <?php echo (basename($_SERVER['PHP_SELF']) == 'schedule.php') ? 'active' : 'text-white'; ?>">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#table"/></svg>
            Schedule
            </a>
        </li>
        <li>
            <a href="#" class="nav-link  <?php echo (basename($_SERVER['PHP_SELF']) == 'consent.php') ? 'active' : 'text-white'; ?>">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#file-earmark-text"/></svg>
            Consent
            </a>
        </li>
        <li>
            <a href="#" class="nav-link  <?php echo (basename($_SERVER['PHP_SELF']) == 'transaction.php') ? 'active' : 'text-white'; ?>">
            <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#clock-history"/></svg>
            Transaction & History
            </a>
        </li>
    ...
    <hr>
      ...
      <div class="dropdown">  
        ...
        <!-- <a href="../../auth/logout.php" class="d-flex align-items-center text-white text-decoration-none">
          </a> -->
